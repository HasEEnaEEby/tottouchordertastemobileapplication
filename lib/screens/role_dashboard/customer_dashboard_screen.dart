...
class _CustomerDashboardState extends State<CustomerDashboard>
  ...
  void initState() {
    ...
    _controller = AnimationController(
      vsync: this,
      duration: const Duration(seconds: 10), // Adjust duration for speed
    );

    // Set up the animation with a range from 0.0 to 1.0
  ...
  // AppBar with Circular Logo and Search Icon
  AppBar _buildAppBar() {
    return AppBar(
      leading: Padding(
        ...
        child: ClipOval(
          child: Image.asset(
            'assets/images/AppLogo.png', // Replace with the path to your logo image
            fit: BoxFit.contain,
  ...
  Widget _buildFavoriteRestaurants() {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 8),
        // Table displaying favorite food ordered from each restaurant
        Table(
...
// Helper function to create table rows for each restaurant and its ordered foods
  ...
  // List of food ordered from a restaurant
  Widget _buildOrderedFoodFromRestaurant(
      String restaurantName, List<String> foodItems) {
    return Padding(
  ...
  Widget _buildRestaurantCard(String restaurantName) {
    return GestureDetector(
      onTap: () {
        // Navigate to the restaurant's menu screen
      },
      child: Card(
    ...
    return Scaffold(
      ...
      body: const Center(
        child: Text(
          ...
          style: TextStyle(
            fontSize: 18,
            color: Colors.blue, // Body text color
          ),
        ),
      ),
    );
    ...
    return Scaffold(
      ...
      body: const Center(
        child: Text(
          ...
          style: TextStyle(
            fontSize: 18,
            color: Colors.purple, // Body text color
          ),
        ),
      ),
    );
    ...
    return Scaffold(
      ...
      body: const Center(
        child: Text(
          ...
          style: TextStyle(
            fontSize: 18,
            color: Colors.red, // Body text color
          ),
        ),
      ),
    );
